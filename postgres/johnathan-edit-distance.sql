...
\copy ( SELECT Year, Name, Gender FROM ssa_names WHERE levenshtein(Name, 'Johnathan') < 4 ORDER BY Year ASC, Name ASC, Gender ASC) TO './postgres/johnathan-edit-distance.csv' WITH CSV DELIMITER ',';
