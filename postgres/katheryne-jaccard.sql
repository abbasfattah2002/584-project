...
\copy ( SELECT Year, Name, Gender FROM ssa_names WHERE similarity(Name, 'Katheryne') > 0.25 ORDER BY Year ASC, Name ASC, Gender ASC) TO './postgres/katheryne-jaccard.csv' WITH CSV DELIMITER ',';
